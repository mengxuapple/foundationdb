...
enum class RestoreCommandEnum {Init = -1, Set_Role = 0, Set_Role_Done, Assign_Applier_KeyRange = 2, Assign_Applier_KeyRange_Done,
...
struct RestoreCommand {
	...
	explicit RestoreCommand(RestoreCommandEnum cmd, CMDUID cmdId, UID id, int64_t cmdIndex): cmd(cmd), cmdId(cmdId), id(id) {};
